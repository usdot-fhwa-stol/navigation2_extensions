...
TEST_F(ComputeAndTrackRouteActionTestFixture, test_tick)
{
  ...
  //             <ComputeAndTrackRoute goal="{goal}" path="{path}" planner_id="GridBased"/>
  //         </BehaviorTree>
  //       </root>)";
...
TEST_F(ComputeAndTrackRouteActionTestFixture, test_tick_use_start)
{
  EXPECT_EQ(2, 1 + 1);
  //   // create tree
  //   std::string xml_txt =
  ...
  //       <root BTCPP_format="4">
  //         <BehaviorTree ID="MainTree">
  //             <ComputeAndTrackRoute goal="{goal}" start="{start}" path="{path}" planner_id="GridBased"/>
  //         </BehaviorTree>
  //       </root>)";
