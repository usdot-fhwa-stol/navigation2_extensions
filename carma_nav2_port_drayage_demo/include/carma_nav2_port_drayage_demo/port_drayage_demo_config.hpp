 ...
 * NOTE: ported from CARMA Platform's port_drayage_plugin package (port_drayage_plugin_config.hpp)
 */
...
namespace carma_nav2_port_drayage_demo
{
  ...
  /**
   * \brief Struct containing the algorithm configuration values for carma_nav2_port_drayage_demo
   */
  struct Config
  {
    ...
    {
      output << "carma_nav2_port_drayage_demo::Config { " << std::endl
